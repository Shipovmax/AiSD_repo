...
class Vehicle:
    ...
    def __init__(self, model: str, vin: str, fuel_capacity: float, load_capacity: float):
...
class Car(Vehicle):
    ...
    def __init__(self, model: str, vin: str, fuel_capacity: float, load_capacity: float, seats: int):
...
class Motorcycle(Vehicle):
    ...
    def __init__(self, model: str, vin: str, fuel_capacity: float, load_capacity: float, has_sidecar: bool):
...
if __name__ == "__main__":
    ...
    print(moto1) # Honda CBR (VIN: VIN456), топливо: 15.0 л, груз: 150.0 кг, без коляски
